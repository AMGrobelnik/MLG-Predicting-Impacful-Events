...
def create_splits_for_folder(base_dir, folder_name, train_split=0.8, val_split=0.1, test_split=0.1, sample_fraction=1.0):
...
if __name__ == "__main__":
    ...
    # Process each folder
    create_splits_for_folder(base_dir, "dim_reduced_10", train_split, val_split, test_split)
